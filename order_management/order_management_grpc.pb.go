...
func (c *orderManagementClient) SearchOrders(ctx context.Context, in *SearchOrderQuery, opts ...grpc.CallOption) (OrderManagement_SearchOrdersClient, error) {
